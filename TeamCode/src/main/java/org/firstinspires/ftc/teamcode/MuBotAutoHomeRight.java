...
@Autonomous(name = "MuBot Auto (Home Right)", group = "MuBot")
public class MuBotAutoHomeRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.update();
        sleep(500);
        encoderDrive(new MotorAction(AUTO_SPEED_ROTATION, 2 * PI * YAW_ROT_CIRCLE_RADIUS * 0.125), new MotorAction(-AUTO_SPEED_ROTATION, -1 * 2 * PI * YAW_ROT_CIRCLE_RADIUS * 0.125), 5);
        telemetry.addData("Auto", "1");
        telemetry.update();
        sleep(500);
        encoderDrive(new MotorAction(AUTO_SPEED_STRAIGHT, TILE_SIZE * 1), new MotorAction(AUTO_SPEED_STRAIGHT, TILE_SIZE * SQRT_2 * 1), 5);
